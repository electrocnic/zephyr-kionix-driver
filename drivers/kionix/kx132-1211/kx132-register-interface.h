...
//
// Note, following "context" data structure kx132_ctx_t, a copy of 
...
typedef int32_t (*kx132_write_ptr)(void *, uint8_t, const uint8_t *, uint16_t);
typedef int32_t (*kx132_read_ptr)(void *, uint8_t, uint8_t *, uint16_t);

typedef struct
{
  /** Component mandatory fields **/
  kx132_write_ptr  write_reg;
  kx132_read_ptr   read_reg;
